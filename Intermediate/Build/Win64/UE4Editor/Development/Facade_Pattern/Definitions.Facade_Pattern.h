...
#define UE_PROJECT_NAME Facade_Pattern
#define UE_TARGET_NAME Facade_PatternEditor
#define UE_MODULE_NAME "Facade_Pattern"
...
#define FACADE_PATTERN_API DLLEXPORT
